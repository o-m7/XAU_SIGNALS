...
MODEL_OUTPUT_PATH = PROJECT_ROOT / "models" / "model3_v2.joblib"
...
def build_cmf_macd_features(df: pd.DataFrame) -> pd.DataFrame:
    """Build CMF and MACD momentum features."""
    df = df.copy()
...
def main():
    print("=" * 80)
    print("MODEL 3 v2: CMF/MACD MOMENTUM")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print("MODEL 3 v2 TRAINING COMPLETE")
    print("=" * 80)
