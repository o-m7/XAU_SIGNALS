#!/usr/bin/env python3
"""
Out-of-Sample Backtest for New Model 1 (2020-2023 trained) on 2024-2025 data.

Tests the new Model 1 with regime detection on 2024-2025 out-of-sample data.
"""
...
def main():
    print("=" * 80)
    print("OUT-OF-SAMPLE BACKTEST: NEW MODEL 1 (2020-2023 trained) on 2024-2025")
    print("=" * 80)
    ...
    print(f"\n✅ Loaded Model 1 (trained on {artifact.get('train_period', 'unknown')})")
